...
//			for(int i=0;i<array[p.e].size();i++) {
//				int nw=array[p.e].get(i).w+dist[p.e];
//				if(nw<dist[array[p.e].get(i).e]) {
//					dist[array[p.e].get(i).e]=nw;
//					q.add(new Point(array[p.e].get(i).e, nw));
//				}
//			}
		}
		for(int i=0;i<V;i++) {
